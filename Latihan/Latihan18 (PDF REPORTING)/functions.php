...
function upload() {
	...
	if ( $error === 4 ) {
	echo "<script> alert('Pilih Gambar Terlebih Dahulu Cuy!!');</script>"; 
	return false;}
	...
	echo "<script> alert('Lu Bukan Upload Gambar Cuy!!');</script>";
	return false;}

	// cek jika ukurannya terlalu besar
	if ( $ukuranFile > 1000000 ) {
	echo "<script> alert('Ukuran Gambar Lu Kegedean Cuy!!');</script>";
	return false;}
...
function edit($data) {
	...
	if ( $_FILES['gambar']['error'] === 4 ) {$gambar = $gambarLama;}
	else {$gambar = upload();}
