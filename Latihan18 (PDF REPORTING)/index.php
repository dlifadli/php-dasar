...
<head>
	...
	<style>
		...
		@media print {.logout, .tambah, .form-cari, .aksi, .cetak{
			display: none;}}
	</style>
...
<body>
<a href="logout.php" onclick="return confirm('Seriusan Mau Logout?')" class="logout">Logout</a> | <a href="cetak.php" class="cetak">Cetak</a>
...
<table border="1" cellpadding="5" cellspacing="0">
	...
	<tr>
	<td><?= $i ?></td>
	<td class="aksi"> <a href="edit.php?id=<?= $mhs["id"] ?>">Edit</a> |
